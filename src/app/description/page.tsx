  ...
  return (
    <div className="flex flex-col p-9">
      <div className="p-8 mb-4 rounded-lg shadow-md flex items-center">
        ...
        <h1 className="text-2xl font-bold mb-2">Mission</h1>
        <p className="text-black">CALI's mission is to support and empower individuals and organizations working in the arts sector by providing research, training, education, and resources to help build their capacity and effectiveness. We believe that a vibrant and sustainable arts sector is essential to Kenya's social and economic development, and we are committed to helping the sector thrive.
        </p>
      </div>
      <div className="mr-4">
      ...
      <div className="p-8 mb-4 rounded-lg shadow-md flex items-center">
        ...
        <div className="flex flex-col">
          <h1 className="text-2xl font-bold mb-2">Vision</h1>
